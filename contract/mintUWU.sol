...
contract test is IERC721Receiver, ReentrancyGuard {
    ...
    uint256 public price = 1250 ether; 
    ...
    function setCost(uint256 _newCost) public onlyDao {
        price = _newCost;
     }
    ...
    function buyNfts(uint256 _amount) public nonReentrant returns (bool) {
        
      
        require(erc20Token.balanceOf(msg.sender) >= price * _amount);
        erc20Token.transferFrom(msg.sender,  address(this), price * _amount);
